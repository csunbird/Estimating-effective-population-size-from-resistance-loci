...
##
module load anaconda3/personal scipy matplotlib
source activate postsim

## command timed to get mem and wallclock info
##
INFILE=$(ls -1 *vcf | head –n $PBS_ARRAY_INDEX)

/usr/bin/time -v \
python CQS21_calculating_TMRCA.py $INFILE ${INFILE}.out
